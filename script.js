...
document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            msg.innerHTML = `<i class="fas fa-exclamation-circle"></i> <strong>Couldn't send message.</strong> Please email us directly at <a href="mailto:hello@dulcelunacakes.com">hello@dulcelunacakes.com</a>.`;
            form.appendChild(msg);
            setTimeout(() => msg.remove(), 8000);
        } finally {
